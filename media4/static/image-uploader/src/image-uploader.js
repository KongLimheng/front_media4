...
;(function ($) {
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            let $button_upload = $('<div>', { class: 'upload-text' })
            ...
            let $uploadedContainer = $('<div>', { class: 'uploaded' }).appendTo(
                ...
                $i = $('<i>', { class: 'iui-cloud-upload' }).appendTo(
                    $textContainer
                ),
        ...
        let createImg = function (src, id, preloaded, type) {
            console.log(src)
            ...
            if (type != 'video/mp4') {
                ...
                let $video = $('<video>', {
                    ...
                    width: '100%',
                    height: '150px',
                    class: 'video_cover_post',
                }).appendTo($container)

                $('<span class="play_post_cover"><i class="far fa-play-circle"></i></span>').appendTo($container)
            }
            let $button = $('<button>', { class: 'delete-image' }).appendTo(
                $container
            )
